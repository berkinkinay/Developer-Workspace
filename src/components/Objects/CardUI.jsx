...
import Animatepages from '../Animate/Animatedpages'
...
<div class='text'>
 <div 
  ...
  >
   <div 
    class=
    'flex absolute mb-10 h-[460px] w-80 bg-slate-500 rounded-xl items-center rotate-6 blur-lg'
    >
  ...
  >        
    ...
    <div 
     class=
     'flex absolute h-fit w-fit top-[220px] gap-2 rounded-2xl'
    >
      <form>
        <label class="block">
