...
>     
 <div class='hidden'> <Object1 /></div>
  ...
  <div class='flex items-center justify-center absolute 3xl:top-20 2xl:top-4 h-36 w-[590px] bg-blue-300 rounded-lg'>
   ...
   'flex bg-slate-500 h-64 w-80 drop-shadow-xl rounded-xl justify-center mt-4 2xl:mt-0'>
    <p 
     ...
     > 
      ...
      some UI, UX stuff and more that I coded. 
      Especially I will be focusing on JavaScript.
    </p>
      <div className='App'>
